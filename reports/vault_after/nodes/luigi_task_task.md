...
```mermaid
flowchart LR
    luigi_task_task --> luigi_init
    luigi_task_task --> luigi_task
    luigi_task_task --> luigi_task_config
    luigi_task_task --> luigi_task_externaltask
    luigi_task_task --> luigi_task_rationale_79
    luigi_task_task --> luigi_task_register_register
    luigi_task_task --> luigi_task_register_taskclassexception
    luigi_task_task --> luigi_task_task_bulk_complete
```
