...
Final values (placeholders — orchestrator will recalibrate before submission):
  ...
  github     = https://github.com/salah-dev-stu/uoh-sqak-ex04  (confirm with Andalus)
  late       = no

Moodle assignment id=274381 — deadline Friday 19 June 2026, 23:59 Asia/Jerusalem

Run:  uv run python scripts/fill_submission_pdf.py
Outputs:
  uoh-sqak-ex04.docx   (filled cover sheet)
  uoh-sqak-ex04.pdf    (final; what each pair member uploads separately to Moodle)
"""
...
TEMPLATE = REPO / "uoh-rl07-ex04-template.docx"

GROUP_CODE = "uoh-sqak"
SELF_GRADE = "85"
EXERCISE_NUMBER = "04"
GITHUB_URL = "https://github.com/salah-dev-stu/uoh-sqak-ex04"
LATE = "no"
...
def main() -> int:
    if not TEMPLATE.exists():
        ...
        return 1
    intermediate = REPO / f"{GROUP_CODE}-ex04.docx"
    ...
    pdf = REPO / f"{GROUP_CODE}-ex04.pdf"
